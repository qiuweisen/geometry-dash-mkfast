...
const gameUrl =
  'https://pub-80cc1196a115483ab41dc7676e40da8c.r2.dev/gdlite/v1/index.html';
    ...
    <main className="mx-auto w-full max-w-6xl px-4 py-8 md:py-12">
      <div className="mb-8 max-w-3xl">
        ...
        <p className="mt-4 text-lg leading-8 text-muted-foreground">
          Jump, dodge the spikes, and replay Geometry Dash Lite directly in your
          browser. No download or signup required.
        </p>
      </div>
      <div className="overflow-hidden rounded-2xl border bg-black shadow-2xl">
        <iframe
          src={gameUrl}
          title="Play Geometry Dash Lite"
      ...
      <section className="mt-10 grid gap-8 md:grid-cols-2">
        <div>
          ...
          <p className="mt-3 leading-7 text-muted-foreground">
            Press Space, Up Arrow, or click to jump on desktop. Tap the game
            area on mobile. Time each jump to clear obstacles and improve your
            run.
          </p>
        </div>
        <div>
          <h2 className="text-2xl font-semibold">Play in your browser</h2>
          <p className="mt-3 leading-7 text-muted-foreground">
            The game loads in an independent player and works on modern desktop
            and mobile browsers with WebGL enabled.
          </p>
          <Link
            to="/how-to-play-geometry-dash-lite"
            className="mt-4 inline-block font-medium text-primary"
          >
            View controls and troubleshooting
          </Link>
        </div>
      </section>
    </main>
